...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ Working with Flutter for mobile applications"),
    emoji("⚡ Integrating with wallet and smart contracts with web.js / ethers.js / solana-web3.js etc")
  ],
...
const workExperiences = {
  ...
  experience: [
    ...
    },
    {
      ...
      company: "Applied Technology Co., Ltd",
      companylogo: require("./assets/images/applied.png"),
      date: "Jun 2016 – Jun 2017",
      desc: "Senior Front-end developer in designing and building responsive web design. Proficient with CSS and JS frameworks, with extensive knowledge of UX and User psychology."
    },
    {
      role: "Full stack developer",
      company: "HouseTable",
      companylogo: require("./assets/images/housetable.png"),
      date: "Jan 2019 – Apr 2022",
      desc: "Senior Full stack developer, developed Front and Back-end and implementing new tech stacks as well as researching them."
    }
  ]
};
...
const bigProjects = {
  ...
  projects: [
    ...
    {
      image: require("./assets/images/housetable.png"),
      projectName: "HouseTable",
      projectDesc: "Real Estate",
      footerLink: [
        {
          name: "Visit Website",
          url: "https://dev.data.housetable.com/"
        }
      ]
    }
  ],
